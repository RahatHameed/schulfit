...
export const BG: string = 'linear-gradient(135deg,#667eea 0%,#764ba2 100%)';
...
export const SPK: CSSProperties = {
  marginTop: 12,
  background: '#667eea',
  border: 'none',
  color: 'white',
...
export const MSPK: CSSProperties = {
  background: '#667eea',
  border: 'none',
  color: 'white',
  borderRadius: '50%',
 ...
 * @param c2 - Secondary color (optional, creates gradient)
 * @returns Button style object
 */
export function B(c1: string, c2?: string): CSSProperties {
  return {
 ...
 * @param c - Badge type ('blue' or other)
 * @returns Badge style object
 */
export function bdg(c: string): CSSProperties {
  return {
