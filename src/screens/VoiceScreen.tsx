          ...
          {isMth && (
            <>
              ...
              <div style={{ fontSize: 13, color: '#888', marginTop: 4 }}>
                {toG(vitem.numA ?? 0)} {vitem.op === '+' ? 'plus' : 'minus'} {toG(vitem.numB ?? 0)}
              </div>
            </>
          )}
            ...
            <>
              ...
              >
                {Array.from({ length: vitem.count || 1 }, (_, i) => (
                  <span key={i} style={{ fontSize: (vitem.count ?? 0) > 1 ? 44 : 72 }}>
                    {vitem.emoji}
                  </span>
                ))}
              </div>
            ...
            >
              ...
              {!isCF && !isCmp && (
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
                  {(stableOpts as string[]).map((val, vi) => (
                    <button
                      key={vi}
