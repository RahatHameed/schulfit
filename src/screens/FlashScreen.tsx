...
import type { Cat, Item, OwlState } from '../types';
                    ...
                    {fitem.phrases.map((ph, i) => (
                      <div
                        ...
                        style={{
                          ...
                          padding: '8px 4px',
                          borderBottom: i < (fitem.phrases?.length ?? 0) - 1 ? '1px solid #f0f0f0' : 'none',
                          cursor: 'pointer'
                        }}
                      >
                        <div>
                    ...
                    {(fitem.content ?? []).map((l, i) => (
                      <div
                        ...
                        style={{
                          fontSize: 13,
                          padding: '5px 0',
                          borderBottom: i < (fitem.content?.length ?? 0) - 1 ? '1px solid #f0f0f0' : 'none',
                          color: '#444'
                        }}
                      >
                        {l}
            ...
            <>
              ...
              <div style={{ display: 'flex', gap: 16, alignItems: 'center', justifyContent: 'center' }}>
                <div style={{ textAlign: 'center' }}>
                  <DotGrid count={fitem.numA ?? 0} color="#667eea" />
                ...
                <div style={{ textAlign: 'center' }}>
                  <DotGrid count={fitem.numB ?? 0} color="#f5576c" />
