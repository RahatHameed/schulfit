// =============================================================================
// DeveloperScreen Component - "About the developer": bio, social media,
// community and support links (split out of the app's About page).
// =============================================================================
...
export function DeveloperScreen({ onBack }: Props) {
  return (
    <div
      style={{
        minHeight: '100vh',
        ...
        >
          ...
          >
            ...
            >
              ...
              <div style={{ fontSize: 10, color: 'rgba(255,255,255,.8)' }}>@rahatrajpoot</div>
            </button>
            <button
          ...
          >
            <div style={{ fontSize: 14, fontWeight: 800, color: 'white' }}>Join the Community</div>
          ...
          >
            <div style={{ fontSize: 14, fontWeight: 800, color: 'white' }}>Support SchulFit</div>
            <div style={{ fontSize: 11, color: 'rgba(255,255,255,.8)' }}>
